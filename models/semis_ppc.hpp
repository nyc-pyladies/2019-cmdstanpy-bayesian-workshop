...
namespace semis_ppc_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "/Users/nitya/Work/2019-cmdstanpy-bayesian-workshop/models/semis_ppc.stan");
    reader.add_event(43, 41, "end", "/Users/nitya/Work/2019-cmdstanpy-bayesian-workshop/models/semis_ppc.stan");
    return reader;
}

class semis_ppc_model
  : public stan::model::model_base_crtp<semis_ppc_model> {
private:
        int I;
        int N;
        ...
        vector_d y;
public:
    semis_ppc_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "semis_ppc_model_namespace::semis_ppc_model";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "semis_ppc_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            Eigen::Matrix<double, Eigen::Dynamic, 1> y_rep(2);
            ...
            stan::model::assign(y_rep, 
                        ...
                        student_t_rng(7, (get_base1(ability, get_base1(team_2, 45, "team_2", 1), "ability", 1) - get_base1(ability, get_base1(team_2, 46, "team_2", 1), "ability", 1)), sigma_y, base_rng__), 
                        "assigning variable y_rep");
            current_statement_begin__ = 39;
            stan::model::assign(y_rep, 
                        stan::model::cons_list(stan::model::index_uni(2), stan::model::nil_index_list()), 
                        student_t_rng(7, (get_base1(ability, get_base1(team_2, 47, "team_2", 1), "ability", 1) - get_base1(ability, get_base1(team_2, 48, "team_2", 1), "ability", 1)), sigma_y, base_rng__), 
                        "assigning variable y_rep");

            // validate, write generated quantities
            current_statement_begin__ = 36;
            size_t y_rep_j_1_max__ = 2;
...
typedef semis_ppc_model_namespace::semis_ppc_model stan_model;

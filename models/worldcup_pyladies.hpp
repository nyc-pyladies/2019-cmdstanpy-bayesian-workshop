...
namespace worldcup_pyladies_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "../models/worldcup_pyladies.stan");
    reader.add_event(43, 41, "end", "../models/worldcup_pyladies.stan");
    return reader;
}

class worldcup_pyladies_model
  : public stan::model::model_base_crtp<worldcup_pyladies_model> {
private:
        int I;
        int N;
        ...
        vector_d y;
public:
    worldcup_pyladies_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "worldcup_pyladies_model_namespace::worldcup_pyladies_model";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "worldcup_pyladies_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                stan::model::assign(y_rep, 
                            ...
                            student_t_rng(7, (get_base1(ability, get_base1(team_1, n, "team_1", 1), "ability", 1) - get_base1(ability, get_base1(team_2, n, "team_2", 1), "ability", 1)), sigma_y, base_rng__), 
    ...
    std::string model_name() const {
        return "worldcup_pyladies_model";
    }
...
typedef worldcup_pyladies_model_namespace::worldcup_pyladies_model stan_model;

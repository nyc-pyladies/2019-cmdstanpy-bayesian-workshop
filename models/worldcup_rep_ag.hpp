...
namespace worldcup_rep_ag_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "../models/worldcup_rep_ag.stan");
    reader.add_event(42, 40, "end", "../models/worldcup_rep_ag.stan");
    return reader;
}

class worldcup_rep_ag_model
  : public stan::model::model_base_crtp<worldcup_rep_ag_model> {
private:
        int I;
        int N;
        ...
        vector_d y;
public:
    worldcup_rep_ag_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "worldcup_rep_ag_model_namespace::worldcup_rep_ag_model";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "worldcup_rep_ag_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef worldcup_rep_ag_model_namespace::worldcup_rep_ag_model stan_model;
